...
class _Payeer extends \IPS\nexus\Gateway
{
	...
	public function settings( &$form )
	{
		...
		$form->add( new \IPS\Helpers\Form\Text('payeer_MerchantURL', $settings ? $settings['MerchantURL'] : '//payeer.com/merchant/', TRUE));
